...
@Service
@Transactional
public class DiccionarioFallasServiceImpl implements DiccionarioFallasService {
    private final FallaDiccionarioRepository fallaRepository;

    public DiccionarioFallasServiceImpl(FallaDiccionarioRepository fallaRepository) {
